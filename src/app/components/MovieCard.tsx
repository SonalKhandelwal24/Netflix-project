...
const MovieCard: React.FC<MovieCardProps> = ({ data }) => {
    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            ...
            {/* ThumbnailUrl image when we hover on the card */}
            <div
                ...
                <div className="z-10 bg-zinc-800 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-md">
                    <div className="flex flex-row items-center gap-3">
                        <div className="cursor-pointer w-6 h-6 lg:h-10 lg:w-10 bg-white rounded-full flex items-center justify-center transition hover:bg-neutral-300"
                            onClick={() => {}}>
                            <BsFillPlayFill size={30} />
                        </div>
                        <FavoriteButton movieid={data?.userid} />
                    </div>
